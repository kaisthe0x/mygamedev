...
public static class EnemyKits
{
    ...
    public static readonly GDict NASEN = new()
    {
        ...
        { "max_health", 90.0 }, { "tier", (int)EnemyTier.Strong }, { "movement", (int)EnemyMovement.Stationary }, { "optional", true }, { "close_type", StrikeType.Aoe.Key() },
    };
    ...
    {
        { "id", EnemyIds.Matat }, { "display_name", "Matat" }, { "tier", (int)EnemyTier.Strong }, { "movement", (int)EnemyMovement.Ground }, { "close_type", StrikeType.Aoe.Key() },
    ...
    public static readonly GDict KROJ = new()
    {
        ...
        { "move_speed", 55.0 }, { "aggro", true }, { "aggro_range", 640.0 },
