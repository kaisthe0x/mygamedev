...
const TABLE := {
	"khalid": {
		...
		"special_stay": [{"scene": preload("res://vfx/character/khalid/special/stay/special_stay.tscn"), "mode": "burst", "frames": [3], "pos": Vector2(22, -20)}],  # the stun blast fires on the forward-thrust frame
		"slam": [
