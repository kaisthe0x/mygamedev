...
/// pos, and optional node / clip_to_ground / follow }. C# port of <c>vfx/config/emitters_characters.gd</c>.
...
public static class EmittersCharacters
{
    ...
    public static readonly GDict TABLE = new()
    {
        ["khalid"] = new GDict
        {
            ...
            ["special_ground_breaker"] = new GArr { new GDict { ["scene"] = S("res://vfx/character/khalid/special/ground_breaker/special_ground_breaker.tscn"), ["mode"] = "burst", ["frames"] = new GArr { 6 }, ["pos"] = new Vector2(0, 0), ["clip_to_ground"] = true } },
            ...
            ["slam"] = new GArr
            {
                ...
                new GDict { ["scene"] = S("res://vfx/character/khalid/slam/default/slam_default.tscn"), ["mode"] = "burst", ["frames"] = new GArr { 3, 4 }, ["pos"] = new Vector2(0, 0), ["clip_to_ground"] = true },
            },
        },
    };
}
